...
from src.api.v1.routers import auth, dictionary, customers, users, orders, operations, operations_flow, stock, warehouse, finances, visits, customer_photos, reports
