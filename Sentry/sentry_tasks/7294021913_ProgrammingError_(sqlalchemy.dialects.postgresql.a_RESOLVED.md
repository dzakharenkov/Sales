...
**Проект:** sales  
**ID Ошибки:** 7294021913  
**Ссылка в Sentry:** https://zakharenkov.sentry.io/issues/7294021913/  
...
**Название ошибки:**
ProgrammingError: (sqlalchemy.dialects.postgresql.asyncpg.ProgrammingError) <class 'asyncpg.exceptions.UndefinedColumnError'>: column ot.executor_role does not exist

**Тип исключения:** UndefinedColumnError  
**Сообщение об ошибке:** column ot.executor_role does not exist  

**Статистика:**
- Кол-во возникновений: **4**
- Первое появление: 2026-02-26T14:32:29Z
- Последнее появление: 2026-02-26T14:33:57Z
- Серьёзность: **ERROR**
...
```json
{
  ...
  "transaction": "/api/v1/operation-types",
  "url": "http://sales.zakharenkov.ru/api/v1/operation-types",
  "user": "ip:84.54.86.3"
}
```
...
Комментарий решения: Исправлена совместимость со схемой БД без колонки executor_role: добавлена проверка наличия колонки и fallback-запросы для operation types.
