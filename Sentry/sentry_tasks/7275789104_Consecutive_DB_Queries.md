...
**Проект:** sales  
**ID Ошибки:** 7275789104  
**Ссылка в Sentry:** https://zakharenkov.sentry.io/issues/7275789104/  
...
**Статистика:**
- Кол-во возникновений: **21**
- Первое появление: 2026-02-19T06:31:50Z
- Последнее появление: 2026-02-22T11:14:38Z
- Серьёзность: **INFO**
...
```json
{
  ...
  "transaction": "/api/v1/dictionary/warehouses",
  "url": "http://127.0.0.1:8000/api/v1/dictionary/warehouses",
  "user": "ip:127.0.0.1"
}
```
