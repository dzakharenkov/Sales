...
**Проект:** ai_realty  
**ID Ошибки:** 7274583098  
**Ссылка в Sentry:** https://zakharenkov.sentry.io/issues/7274583098/  
...
**Название ошибки:**
ProgrammingError: (sqlalchemy.dialects.postgresql.asyncpg.ProgrammingError) <class 'asyncpg.exceptions.UndefinedObjectError'>: type "ai_realty.user_role_enum" does not exist

**Тип исключения:** UndefinedObjectError  
**Сообщение об ошибке:** type "ai_realty.user_role_enum" does not exist  

**Статистика:**
- Кол-во возникновений: **8**
- Первое появление: 2026-02-18T17:32:46Z
- Последнее появление: 2026-02-18T17:40:15Z
- Серьёзность: **ERROR**
