...
**Проект:** ai_realty  
**ID Ошибки:** 7274886445  
**Ссылка в Sentry:** https://zakharenkov.sentry.io/issues/7274886445/  
...
```json
{
  ...
  "server_name": "Sokol",
  "transaction": "/api/v1/ai/portfolio-optimization",
  "url": "http://test/api/v1/ai/portfolio-optimization",
  "user": "ip:127.0.0.1"
}
```
