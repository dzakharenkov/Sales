...
**Проект:** sales  
**ID Ошибки:** 7283614569  
**Ссылка в Sentry:** https://zakharenkov.sentry.io/issues/7283614569/  
...
**Название ошибки:**
IntegrityError: (sqlalchemy.dialects.postgresql.asyncpg.IntegrityError) <class 'asyncpg.exceptions.ForeignKeyViolationError'>: update or delete on table "customers" violates foreign key constraint "orders_customer_id_fkey" on table "orders"

**Тип исключения:** ForeignKeyViolationError  
**Сообщение об ошибке:** update or delete on table "customers" violates foreign key constraint "orders_customer_id_fkey" on table "orders"  

**Статистика:**
- Кол-во возникновений: **3**
- Первое появление: 2026-02-22T09:44:40Z
- Последнее появление: 2026-02-22T09:51:08Z
- Серьёзность: **ERROR**
...
```json
{
  ...
  "transaction": "/api/v1/customers/{customer_id}",
  "url": "http://127.0.0.1:8000/api/v1/customers/21",
  "user": "ip:127.0.0.1"
}
```
