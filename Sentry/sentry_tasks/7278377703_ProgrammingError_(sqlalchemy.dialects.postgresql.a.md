...
**Проект:** sales  
**ID Ошибки:** 7278377703  
**Ссылка в Sentry:** https://zakharenkov.sentry.io/issues/7278377703/  
...
**Название ошибки:**
ProgrammingError: (sqlalchemy.dialects.postgresql.asyncpg.ProgrammingError) <class 'asyncpg.exceptions.UndefinedColumnError'>: column "region" does not exist

**Тип исключения:** UndefinedColumnError  
**Сообщение об ошибке:** column "region" does not exist  

**Статистика:**
- Кол-во возникновений: **5**
- Первое появление: 2026-02-20T04:55:00Z
- Последнее появление: 2026-02-20T12:31:26Z
- Серьёзность: **ERROR**
...
```json
{
  ...
  "transaction": "/api/v1/dictionary/cities",
  "url": "http://127.0.0.1:8000/api/v1/dictionary/cities",
  "user": "ip:127.0.0.1"
}
```
