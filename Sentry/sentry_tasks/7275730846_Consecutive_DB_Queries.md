...
**Проект:** sales  
**ID Ошибки:** 7275730846  
**Ссылка в Sentry:** https://zakharenkov.sentry.io/issues/7275730846/  
...
**Статистика:**
- Кол-во возникновений: **28**
- Первое появление: 2026-02-19T05:48:19Z
...
```json
{
  ...
  "transaction": "/api/v1/dictionary/payment-types",
  "url": "http://127.0.0.1:8000/api/v1/dictionary/payment-types",
  "user": "ip:127.0.0.1"
}
```
