...
**Проект:** ai_realty  
**ID Ошибки:** 7274427115  
**Ссылка в Sentry:** https://zakharenkov.sentry.io/issues/7274427115/  
...
**Название ошибки:**
Database session error: 401: User not found
...
- Первое появление: 2026-02-18T16:19:27Z
- Последнее появление: 2026-02-19T17:26:40Z
- Серьёзность: **ERROR**
...
```json
{
  ...
  "level": "error",
  "logger": "app.database.connection",
