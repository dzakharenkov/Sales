...
**Проект:** sales  
**ID Ошибки:** 7275718892  
**Ссылка в Sentry:** https://zakharenkov.sentry.io/issues/7275718892/  
...
**Статистика:**
- Кол-во возникновений: **32**
- Первое появление: 2026-02-19T05:37:13Z
- Последнее появление: 2026-02-23T03:39:48Z
- Серьёзность: **INFO**
...
```json
{
  ...
  "transaction": "/api/v1/orders/statuses",
  "url": "http://127.0.0.1:8000/api/v1/orders/statuses",
  "user": "ip:127.0.0.1"
}
```
