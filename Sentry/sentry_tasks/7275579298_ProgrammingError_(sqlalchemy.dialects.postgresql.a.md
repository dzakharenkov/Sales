...
**Проект:** ai_realty  
**ID Ошибки:** 7275579298  
**Ссылка в Sentry:** https://zakharenkov.sentry.io/issues/7275579298/  
...
**Название ошибки:**
ProgrammingError: (sqlalchemy.dialects.postgresql.asyncpg.ProgrammingError) <class 'asyncpg.exceptions.UndefinedColumnError'>: column users.failed_login_attempts does not exist

**Тип исключения:** UndefinedColumnError  
**Сообщение об ошибке:** column users.failed_login_attempts does not exist  

**Статистика:**
- Кол-во возникновений: **1**
- Первое появление: 2026-02-19T03:43:56Z
- Последнее появление: 2026-02-19T03:43:56Z
- Серьёзность: **ERROR**
