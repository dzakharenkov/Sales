...
**Проект:** ai_realty  
**ID Ошибки:** 7277085414  
**Ссылка в Sentry:** https://zakharenkov.sentry.io/issues/7277085414/  
...
**Название ошибки:**
ProgrammingError: (sqlalchemy.dialects.postgresql.asyncpg.ProgrammingError) <class 'asyncpg.exceptions.UndefinedColumnError'>: column maintenance_expenses.expected_amount does not exist

**Тип исключения:** UndefinedColumnError  
**Сообщение об ошибке:** column maintenance_expenses.expected_amount does not exist  

**Статистика:**
- Кол-во возникновений: **1**
- Первое появление: 2026-02-19T17:14:21Z
- Последнее появление: 2026-02-19T17:14:21Z
- Серьёзность: **ERROR**
...
```json
{
  ...
  "server_name": "Sokol",
  "transaction": "/api/v1/properties/{property_id:int}/expenses",
  "url": "http://127.0.0.1:8002/api/v1/properties/1/expenses",
  "user": "ip:127.0.0.1"
}
```
