...
**Проект:** ai_realty  
**ID Ошибки:** 7274427269  
**Ссылка в Sentry:** https://zakharenkov.sentry.io/issues/7274427269/  
...
**Название ошибки:**
ProgrammingError: (sqlalchemy.dialects.postgresql.asyncpg.ProgrammingError) <class 'asyncpg.exceptions.UndefinedColumnError'>: column properties.loan_amount does not exist

**Тип исключения:** UndefinedColumnError  
**Сообщение об ошибке:** column properties.loan_amount does not exist  

**Статистика:**
- Кол-во возникновений: **1**
- Первое появление: 2026-02-18T16:19:32Z
- Последнее появление: 2026-02-18T16:19:32Z
- Серьёзность: **ERROR**
...
```json
{
  ...
  "server_name": "Sokol",
  "transaction": "/api/v1/portfolio/summary",
  "url": "http://127.0.0.1:8002/api/v1/portfolio/summary",
  "user": "ip:127.0.0.1"
}
```
