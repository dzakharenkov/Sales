...
**Проект:** sales  
**ID Ошибки:** 7294095442  
**Ссылка в Sentry:** https://zakharenkov.sentry.io/issues/7294095442/  
...
**Название ошибки:**
IntegrityError: (sqlalchemy.dialects.postgresql.asyncpg.IntegrityError) <class 'asyncpg.exceptions.ForeignKeyViolationError'>: update or delete on table "operation_types" violates foreign key constraint "operation_config_operation_type_code_fkey" on table "operation_co...

**Тип исключения:** ForeignKeyViolationError  
**Сообщение об ошибке:** update or delete on table "operation_types" violates foreign key constraint "operation_config_operation_type_code_fkey" on table "operation_config"  

**Статистика:**
- Кол-во возникновений: **2**
- Первое появление: 2026-02-26T15:03:11Z
- Последнее появление: 2026-02-26T15:03:30Z
- Серьёзность: **ERROR**
...
```json
{
  ...
  "transaction": "/api/v1/operation-types/{code}",
  "url": "http://sales.zakharenkov.ru/api/v1/operation-types/damage",
  "user": "ip:84.54.86.3"
}
```
...
Комментарий решения: Исправлено удаление типа операции: добавлена корректная обработка связанных данных и возврат понятной ошибки без падения API (FK violation handled).
