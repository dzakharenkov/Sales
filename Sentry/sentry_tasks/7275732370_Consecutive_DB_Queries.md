...
**Проект:** sales  
**ID Ошибки:** 7275732370  
**Ссылка в Sentry:** https://zakharenkov.sentry.io/issues/7275732370/  
...
**Статистика:**
- Кол-во возникновений: **27**
- Первое появление: 2026-02-19T05:49:44Z
- Последнее появление: 2026-02-23T03:45:06Z
- Серьёзность: **INFO**
...
```json
{
  ...
  "url": "http://127.0.0.1:8000/api/v1/operation-types",
  "user": "ip:127.0.0.1"
}
```
