...
**Проект:** sales  
**ID Ошибки:** 7278377770  
**Ссылка в Sentry:** https://zakharenkov.sentry.io/issues/7278377770/  
...
**Название ошибки:**
ProgrammingError: (sqlalchemy.dialects.postgresql.asyncpg.ProgrammingError) <class 'asyncpg.exceptions.UndefinedColumnError'>: column "city_id" does not exist

**Тип исключения:** UndefinedColumnError  
**Сообщение об ошибке:** column "city_id" does not exist  

**Статистика:**
- Кол-во возникновений: **3**
- Первое появление: 2026-02-20T04:55:07Z
- Последнее появление: 2026-02-20T04:55:55Z
- Серьёзность: **ERROR**
...
```json
{
  ...
  "transaction": "/api/v1/dictionary/territories",
  "url": "http://127.0.0.1:8000/api/v1/dictionary/territories",
  "user": "ip:127.0.0.1"
}
```
