...
**Проект:** ai_realty  
**ID Ошибки:** 7274878274  
**Ссылка в Sentry:** https://zakharenkov.sentry.io/issues/7274878274/  
...
- Первое появление: 2026-02-18T20:04:32Z
- Последнее появление: 2026-02-18T20:04:32Z
- Серьёзность: **ERROR**
...
```json
{
  ...
  "server_name": "Sokol",
  "transaction": "/api/v1/reports/properties",
  "url": "http://127.0.0.1:8002/api/v1/reports/properties",
  "user": "ip:127.0.0.1"
}
```
