...
**Проект:** sales  
**ID Ошибки:** 7285021972  
**Ссылка в Sentry:** https://zakharenkov.sentry.io/issues/7285021972/  
...
**Название ошибки:**
[SAVE API ERROR] User 1113288292: API error: SDS API 500: {'error': {'code': 'INTERNAL_ERROR', 'message': 'Внутренняя ошибка сервера'}}, status=500, detail={'error': {'code': 'INTERNAL_ERROR', 'message': 'Внутренняя ошибка сервера'}}
