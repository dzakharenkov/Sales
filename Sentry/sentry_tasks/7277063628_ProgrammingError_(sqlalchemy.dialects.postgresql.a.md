...
**Проект:** ai_realty  
**ID Ошибки:** 7277063628  
**Ссылка в Sentry:** https://zakharenkov.sentry.io/issues/7277063628/  
...
**Название ошибки:**
ProgrammingError: (sqlalchemy.dialects.postgresql.asyncpg.ProgrammingError) <class 'asyncpg.exceptions.UndefinedColumnError'>: column rent_payments.expected_amount does not exist

**Тип исключения:** UndefinedColumnError  
**Сообщение об ошибке:** column rent_payments.expected_amount does not exist  

**Статистика:**
- Кол-во возникновений: **4**
- Первое появление: 2026-02-19T17:04:55Z
- Последнее появление: 2026-02-19T17:06:01Z
- Серьёзность: **ERROR**
...
```json
{
  ...
  "server_name": "Sokol",
  "transaction": "/api/v1/rent-payments",
  "url": "http://test/api/v1/rent-payments",
  "user": "ip:127.0.0.1"
}
```
