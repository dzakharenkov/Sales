...
**Название ошибки:**
Database session error: (sqlalchemy.dialects.postgresql.asyncpg.Error) <class 'asyncpg.exceptions.NumericValueOutOfRangeError'>: numeric field overflow

**Тип исключения:** Unknown  
**Сообщение об ошибке:** Unknown  

**Статистика:**
- Кол-во возникновений: **128**
